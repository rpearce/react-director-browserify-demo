  ...
  render: function() {
    ...
    return (
      React.createElement("div", null, 
        React.createElement(Movies, {items: this.state.movies, addMovie: this._addMovie}), 
        React.createElement(Bands, {items: this.state.bands})
      )
    );
  },
...
},{"./Bands.react":162,"./Movies.react":164,"director":4,"react":159}],161:[function(require,module,exports){
var React = require('react');

var Band = React.createClass({displayName: "Band",
  render: function() {
    return (
      React.createElement("a", {href: '#/bands/' + this.props.item.split(' ').join('-')}, this.props.item)
    );
  }
});
...
var Bands = React.createClass({displayName: "Bands",
  render: function() {
    return (
      React.createElement("div", null, this._buildItems())
    );
  },

  _buildItems: function() {
    return this.props.items.map(function(item) {
      return React.createElement(Band, {item: item, key: item});
    });
  }
});
...
},{"./Band.react":161,"react":159}],163:[function(require,module,exports){
var React = require('react');

var Movie = React.createClass({displayName: "Movie",
  render: function() {
    return (
      React.createElement("a", {href: '#/movies/' + this.props.item.split(' ').join('-')}, this.props.item)
    );
  }
});
...
var Movies = React.createClass({displayName: "Movies",
  render: function() {
    ...
    return (
      React.createElement("div", null, 
        React.createElement("form", {onSubmit: this._triggerAddMovie}, 
          React.createElement("input", {ref: "input", placeholder: "Add new movie"}), 
        ...
        this.props.items.map(function(item) {
          return React.createElement(Movie, {item: item, key: item});
        })
      )
    );
  },
